...
# Assuming the datasets are `hospital_predictions`, `municipality_predictions`, and `school_predictions`
# Each dataset contains "CalendarYear", "Actual", and "Predicted" columns.

# 1. Plot for Hospital Dataset
hospital_actual_vs_predicted <- ggplot(hospital_predictions, aes(x = CalendarYear)) +
  geom_point(aes(y = Actual, color = "Actual"), size = 1, alpha = 0.5) +
  geom_point(aes(y = Predicted, color = "Predicted"), size = 1, alpha = 0.5) +
  geom_line(aes(y = Actual, color = "Actual"), linetype = "solid", size = 0.8, alpha = 0.7) +
  geom_line(aes(y = Predicted, color = "Predicted"), linetype = "dashed", size = 0.8, alpha = 0.7) +
  labs(title = "Actual vs Predicted Total Compensation (Hospital)",
       x = "Calendar Year",
...
# 2. Plot for Municipality Dataset
municipality_actual_vs_predicted <- ggplot(municipality_predictions, aes(x = CalendarYear)) +
  geom_point(aes(y = Actual, color = "Actual"), size = 1, alpha = 0.5) +
  geom_point(aes(y = Predicted, color = "Predicted"), size = 1, alpha = 0.5) +
  geom_line(aes(y = Actual, color = "Actual"), linetype = "solid", size = 0.8, alpha = 0.7) +
  geom_line(aes(y = Predicted, color = "Predicted"), linetype = "dashed", size = 0.8, alpha = 0.7) +
  labs(title = "Actual vs Predicted Total Compensation (Municipality)",
       x = "Calendar Year",
       y = "Total Compensation",
       color = "Legend") +
  scale_color_manual(values = c("Actual" = "blue", "Predicted" = "red")) +
...
# 3. Plot for School Dataset
school_actual_vs_predicted <- ggplot(school_predictions, aes(x = CalendarYear)) +
  geom_point(aes(y = Actual, color = "Actual"), size = 1, alpha = 0.5) +
  geom_point(aes(y = Predicted, color = "Predicted"), size = 1, alpha = 0.5) +
  geom_line(aes(y = Actual, color = "Actual"), linetype = "solid", size = 0.8, alpha = 0.7) +
  geom_line(aes(y = Predicted, color = "Predicted"), linetype = "dashed", size = 0.8, alpha = 0.7) +
  labs(title = "Actual vs Predicted Total Compensation (School)",
       x = "Calendar Year",
       y = "Total Compensation",
       color = "Legend") +
  scale_color_manual(values = c("Actual" = "blue", "Predicted" = "red")) +
...
# Display the plots
print(hospital_actual_vs_predicted)
print(municipality_actual_vs_predicted)
print(school_actual_vs_predicted)
